...
var idigger = (function(_w) {
    ...
    var trackConfig = {
        ...
        "utaq": {
            normal: function() {
                ...
                _utaq.push(["setTrackerUrl", protocolUrl("sit.gentags.net/site/unids.gif")]);
            ...
            url: protocolUrl("sit.gentags.net/adagent/js/uta.js")
        },
        /**UniclickSearch**/
        "utaq_search": {
        ...
        "mvq": {
            ...
            product: function(param) {
                ...
                _mvq.push(['$addGoods', /*分类id*/ param.cate_id, /*品牌id*/ param.brand_id, /*商品名称*/ param.pro_name, /*商品ID*/ param.pro_id, /*商品售价*/ param.pro_price, /*商品图片url*/ param.pro_img_url, /*分类名*/ param.cate_name, /*品牌名*/ param.brand_name, /*商品库存状态1或是0*/ param.pro_num ? 1 : 0, /*网络价*/ param.pro_net_price, /*收藏人数*/ param.pro_col_num, /*商品下架时间*/ param.pro_off_time]);
    ...
    var pageConfig = {
        ...
        "register_accomplish": function(_p) {
            var rtTag = {
                "data": {
                    "ecom_reg": {
                        "phone": (/^0?1[3|4|5|8][0-9]\d{8}$/.test(_p.phone_number)) ? 1 : 0
                    }
                }
            };
            trackConfig.baidu_hm["normal"] = trackConfig.baidu_hm["normal"].bind(null, rtTag);
    ...
    var fire = function(param) {
        var eventConfig = {
            ...
            /*点击注册完成*/
            "register_accomplish": function() {
                _utaq.push(["trackEvent", "https://shop.feiniu.com/member/doSignup"]);
            }
        };
